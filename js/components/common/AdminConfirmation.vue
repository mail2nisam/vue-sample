<template>
    <transition name="modal">
        <div class="modal-mask" v-if="removeData.type==='submitted' || removeData.type==='draft'">
            <div class="modal-wrapper">
                <div class="modal-container confirm-modal-container" v-outside-click="closeConfirm">
                    ...
                    <div class="modal-body">
                        <p>The Abstract status will be changed to {{removeData.type==="draft"?'Submitted':'Draft'}}.</p>
                        <button @click.stop="closeConfirm" class="btn-primary btn-cancel">Cancel</button>
                        <button @click.stop="changeStatus" class="btn-primary">Change</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    export default {
        ...
        methods: {
            /**
             * Change the confirmation status to false
             */
            ...
            deleteItem: function () {
                ...
                switch (type) {
                    case 'abstract':
                        this.$store.dispatch("deleteAdminAbstract", id);
                        break;
                    case 'people':
