<template>
    <div class="container container-small">
        <div class="box-white">
            ...
            <div class="form-container">
                <form class="square-input-form">
                    ...
                    <div class="form-group">
                        <label for="topic" class="form-label">Please select the topic that your abstract best belongs to
        ...
        <footer class="content-footer">
            ...
            <div>
                <a href="" class="btn-secondary" @click.prevent="next">Save</a>
            </div>
        </footer>
    </div>
</template>
        ...
        methods: {
            ...
            sendFormDataToServer: function () {
                ...
                if (!this.formId) {
                    ...
                    this.$store.dispatch("createAdminFormEntry")
                        .then(
                            response => {
                    ...
                    this.$store.commit("setLoader", true);
                    this.$store.dispatch("adminUpdateFormEntry")
                        .then(
                            response => {
            ...
            redirectToNextStep: function (id) {
                ...
                // this.$store.commit('setStep', 2);
                this.$router.push({name: 'admin-abstract-preview', params: {id: this.$route.params.id}});
            },
            /**
