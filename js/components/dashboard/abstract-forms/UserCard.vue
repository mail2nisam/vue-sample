    ...
    <div class="card card-white">
        ...
        <div class="card-inner">
            <div class="card-inner-details">
                ...
                <!-- dropdown -->
                <div class="dropdown-wrap" v-if="$route.name==='author'">
            ...
            <div class="tag-cloud">
                ...
                <span class="tag tag-author" v-if="people.author">Author <i class="close-icon"
                                                                            v-if="$route.name==='author'"
                                                                            @click.prevent="removeTag('author')"></i></span>
                <span class="tag tag-author" v-if="people.co_author">Co-author <i class="close-icon"
                                                                                  v-if="$route.name==='author'"
                                                                                  @click.prevent="removeTag('co_author')"></i></span>
                <span class="tag tag-presenter" v-if="people.presenter">Presenter <i class="close-icon"
                                                                                     v-if="$route.name==='author'"
                                                                                     @click.prevent="removeTag('presenter')"></i></span>
            </div>
        </div>
    </div>
</template>
