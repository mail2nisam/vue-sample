<template>
    <div class="main-wrapper">
        ...
        <admin-confirmation v-show="confirm"/>
    </div>
</template>
...
<script>
    ...
    import AdminConfirmation from "./common/AdminConfirmation";

    export default {
        name: "AdminHome",
        components: {AdminConfirmation, NavBar, Confirmation, Modal, FilterPanel, SidePanel},
        data: () => {
            return {
                toggleStatus: false,
                isOpen: false
